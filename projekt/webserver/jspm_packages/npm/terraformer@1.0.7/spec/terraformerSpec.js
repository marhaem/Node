...
if (typeof module === "object") {
  ...
  var GeoJSON = require('./geojsonHelpers');
}
beforeEach(function() {
  this.addMatchers({toBeInstanceOfClass: function(classRef) {
...
describe("Primitives", function() {
  ...
  describe("LineString", function() {
    ...
    it("should calculate convex hull", function() {
      ...
      expect(lineString.convexHull().coordinates).toEqual([[[100, 0], [-45, 122], [80, -60], [100, 0]]]);
    });
    it("should return null when a convex hull cannot return a valid Polygon", function() {
      expect(lineString.convexHull()).toEqual(null);
    });
    it("should calculate envelope", function() {
      expect(lineString.envelope()).toEqual({
        x: -45,
        y: 0,
        w: 145,
        h: 122
  ...
  describe("MultiLineString", function() {
    var multiLineString;
    beforeEach(function() {
      multiLineString = new Terraformer.MultiLineString([[[-105, 40], [-110, 45], [-115, 55]], [[-100, 40], [-105, 45], [-110, 55]]]);
    });
    it("should create a MultiLineString from an array of GeoJSON LineStrings", function() {
      ...
      expect(multiLineString.coordinates).toEqual([[[-105, 40], [-110, 45], [-115, 55]], [[-100, 40], [-105, 45], [-110, 55]]]);
    });
    it("should throw an error when called invalid data", function() {
      expect(function() {
    ...
    it("should calculate convex hull", function() {
      ...
      expect(multiLineString.convexHull().coordinates).toEqual([[[-100, 40], [-110, 55], [-115, 55], [-110, 45], [-105, 40], [-100, 40]]]);
    });
    it("should calculate envelope", function() {
      expect(multiLineString.envelope()).toEqual({
        x: -115,
        y: 40,
        w: 15,
        h: 15
  ...
  describe("Polygon", function() {
    ...
    beforeEach(function() {
      ...
      polygonWithHoles = new Terraformer.Polygon([[[100.0, 0.0], [101.0, 0.0], [101.0, 1.0], [100.0, 1.0], [100.0, 0.0]], [[100.2, 0.2], [100.8, 0.2], [100.8, 0.8], [100.2, 0.8], [100.2, 0.2]]]);
    });
    ...
    it("should calculate convex hull", function() {
      expect(polygon.convexHull().coordinates).toEqual([[[101, 1], [100, 1], [100, 0], [101, 0], [101, 1]]]);
      expect(polygon.convexHull().type).toEqual("Polygon");
    });
    it("should calculate envelope", function() {
      expect(polygon.envelope()).toEqual({
        x: 100.0,
        y: 0,
        w: 1,
        h: 1
  ...
  describe("MultiPolygon", function() {
    ...
    it("should return true when a MultiPolygon intersects another", function() {
      mp = new Terraformer.MultiPolygon([[[[102.0, 2.0], [103.0, 2.0], [103.0, 3.0], [102.0, 3.0], [102.0, 2.0]]], [[[100.0, 0.0], [102.0, 0.0], [102.0, 1.0], [100.0, 1.0], [100.0, 0.0]]]]);
    ...
    it("should calculate convex hull", function() {
      expect(mp.convexHull().coordinates).toEqual([[[103, 3], [102, 3], [100, 1], [100, 0], [102, 0], [103, 2], [103, 3]]]);
      expect(multiPolygon.convexHull().type).toEqual("Polygon");
    });
    it("should calculate envelope", function() {
      expect(multiPolygon.envelope()).toEqual({
        x: 100,
        y: 0,
        w: 3,
        h: 3
    ...
    it("should be able to be closed", function() {
      var unclosed = new Terraformer.MultiPolygon({
        "type": "MultiPolygon",
        "coordinates": [[[[102.0, 2.0], [103.0, 2.0], [103.0, 3.0], [102.0, 3.0]], [[102.2, 2.2], [102.8, 2.2], [102.8, 2.8], [102.2, 2.8]]], [[[100.0, 0.0], [101.0, 0.0], [101.0, 1.0], [100.0, 1.0]], [[100.2, 0.2], [100.8, 0.2], [100.8, 0.8], [100.2, 0.8]]]]
      });
      unclosed.close();
  ...
  describe("Circle", function() {
    ...
    it("should create a Circle Feature from a GeoJSON Position and a radius", function() {
      ...
      expect(circle.geometry.coordinates[0].length).toEqual(129);
    });
    it("should throw an error when called invalid data", function() {
      expect(function() {
  ...
  describe("Feature", function() {
    ...
    it("should throw an error when called invalid data", function() {
      expect(function() {
        new Terraformer.Feature({type: "Polygon"}).toThrow("Terraformer: invalid input for Terraformer.Feature");
      });
    });
    it("should calculate bounds", function() {
    ...
    it("should calculate envelope", function() {
      expect(feature.envelope()).toEqual({
        x: 21.79,
        y: 33.75,
        w: 35.160000000000004,
        h: 37.260000000000005
      });
    });
    it("should calculate convex hull", function() {
      expect(feature.convexHull().type).toEqual("Polygon");
      expect(feature.convexHull().coordinates).toEqual([[[56.95, 33.75], [41.83, 71.01], [21.79, 36.56], [56.95, 33.75]]]);
    });
  });
  describe("FeatureCollection", function() {
    var featureCollection;
    beforeEach(function() {
      featureCollection = new Terraformer.FeatureCollection([GeoJSON.features[0], GeoJSON.features[1]]);
    });
    ...
    it("should throw an error when called invalid data", function() {
      expect(function() {
        new Terraformer.FeatureCollection({"type": "Polygon"}).toThrow("Terraformer: invalid input for Terraformer.FeatureCollection");
      });
    });
    it("should calculate bounds", function() {
    ...
    it("should calculate envelope", function() {
      expect(featureCollection.envelope()).toEqual({
        x: -104.99404,
        y: 33.75,
        w: 161.94404,
        h: 37.260000000000005
  ...
  describe("GeometryCollection", function() {
    ...
    it("should throw an error when called invalid data", function() {
      expect(function() {
        new Terraformer.GeometryCollection({"type": "Polygon"}).toThrow("Terraformer: invalid input for Terraformer.GeometryCollection");
      });
    });
    it("should calculate bounds", function() {
    ...
    it("should calculate envelope", function() {
      expect(geometryCollection.envelope()).toEqual({
        x: -84.32281494140625,
        y: 33.73804486328907,
        w: 141.27281494140624,
        h: 37.271955136710936
      });
    });
...
describe("Intersection", function() {
  ...
  describe("Catch All", function() {
    ...
    it("should return null when there is no geometry in a Feature in calculateBounds", function() {
      var bounds = Terraformer.Tools.calculateBounds({
        type: "Feature",
        geomertry: null
      });
    ...
    it("should return false when polygonContainsPoint is passed an empty polygon", function() {
      ...
      var polygon = [[[-112.074279, 40.52215], [-112.074279, 40.853293], [-111.610107, 40.853293], [-111.610107, 40.52215], [-112.074279, 40.52215]]];
