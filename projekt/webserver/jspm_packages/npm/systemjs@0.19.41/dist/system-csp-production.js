      ...
      !function(e) {
          ...
          for (var o in t)
            if (J.call(["main", "format", "defaultExtension", "basePath"], o) != -1)
              ...
              for (var i in t.depCache) {
                var s;
                s = "./" == i.substr(0, 2) ? n + "/" + i.substr(2) : j.call(r, i), r.depCache[s] = (r.depCache[s] || []).concat(t.depCache[i]);
              }
            else
        ...
        a.prototype.config = function(e, t) {
          ...
          if ("loaderErrorStack" in e && (ne = $__curScript, e.loaderErrorStack ? $__curScript = void 0 : $__curScript = ne), "warnings" in e && (r.warnings = e.warnings), e.transpilerRuntime === !1 && (r._loader.loadedTranspilerRuntime = !0), ("production" in e || "build" in e) && _.call(r, !!e.production, !!(e.build || W && W.build)), !t) {
            ...
            if (e.paths && g(r.paths, e.paths), k(r, e, function(e) {
              e.paths && g(r.paths, e.paths);
            }), this.warnings)
              for (var o in r.paths)
                o.indexOf("*") != -1 && w.call(r, 'Paths configuration "' + o + '" -> "' + r.paths[o] + '" uses wildcards which are being deprecated for just leaving a trailing "/" to indicate folder paths.');
          }
            ...
            for (var o in e.map) {
              ...
              if ("string" != typeof i) {
                var s = r.defaultJSExtensions && ".js" != o.substr(o.length - 3, 3),
                    l = r.decanonicalize(o);
                s && ".js" == l.substr(l.length - 3, 3) && (l = l.substr(0, l.length - 3));
                var u = "";
                for (var c in r.packages)
                  l.substr(0, c.length) == c && (!l[c.length] || "/" == l[c.length]) && u.split("/").length < c.split("/").length && (u = c);
                u && r.packages[u].main && (l = l.substr(0, l.length - r.packages[u].main.length - 1));
                var c = r.packages[l] = r.packages[l] || {};
                c.map = i;
              } else
                r.map[o] = i;
            }
          ...
          if (e.bundles)
            for (var o in e.bundles) {
              for (var y = [],
                  m = 0; m < e.bundles[o].length; m++) {
                var s = r.defaultJSExtensions && ".js" != e.bundles[o][m].substr(e.bundles[o][m].length - 3, 3),
                    x = r.decanonicalize(e.bundles[o][m]);
                s && ".js" == x.substr(x.length - 3, 3) && (x = x.substr(0, x.length - 3)), y.push(x);
              }
              r.bundles[o] = y;
            }
          if (e.packages)
            for (var o in e.packages) {
              ...
              var l = j.call(r, o);
              "/" == l[l.length - 1] && (l = l.substr(0, l.length - 1)), b(r, l, e.packages[o], !1);
            }
          for (var S in e) {
            var i = e[S];
            if (J.call(["baseURL", "map", "packages", "bundles", "paths", "warnings", "packageConfigPaths", "loaderErrorStack", "browserConfig", "nodeConfig", "devConfig", "buildConfig", "productionConfig"], S) == -1)
              if ("object" != typeof i || i instanceof Array)
                ...
                for (var o in i)
                  if ("meta" == S && "*" == o[0])
                    ...
                    var P = j.call(r, o);
                    r.defaultJSExtensions && ".js" != P.substr(P.length - 3, 3) && !d(P) && (P += ".js"), g(r[S][P] = r[S][P] || {}, i[o]);
                  } else if ("depCache" == S) {
                    var s = r.defaultJSExtensions && ".js" != o.substr(o.length - 3, 3),
                        l = r.decanonicalize(o);
                    s && ".js" == l.substr(l.length - 3, 3) && (l = l.substr(0, l.length - 3)), r[S][l] = [].concat(i[o]);
                  } else
                    r[S][o] = i[o];
              }
          }
          ...
          i("decanonicalize", a), i("normalizeSync", a), i("normalize", function(a) {
            ...
            return function(t) {
              ...
              return t.metadata.loaderModule && t.metadata.loaderModule.instantiate && !n.builder && "defined" != t.metadata.format ? Promise.resolve(t.metadata.loaderModule.instantiate.call(n, t, function(t) {
                ...
                return r ? a : (void 0 !== a && (t.metadata.entry = R(), t.metadata.entry.execute = function() {
                  return a;
        ...
        }), X = new a, e.SystemJS = X, X.version = "0.19.41 CSP", "object" == typeof module && module.exports && "object" == typeof exports && (module.exports = X), e.System = X;
      }("undefined" != typeof self ? self : global);
    }
    var t = "undefined" == typeof Promise;
    if ("undefined" != typeof document) {
      var n = document.getElementsByTagName("script");
      if ($__curScript = n[n.length - 1], document.currentScript && ($__curScript.defer || $__curScript.async) && ($__curScript = document.currentScript), $__curScript.src || ($__curScript = void 0), t) {
