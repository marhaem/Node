    ...
    function e() {
      !function(e) {
        ...
        function t(e, t) {
          ...
          var i = J ? new Error(o, e.fileName, e.lineNumber) : new Error(o);
        ...
        var $,
            J = "_" == new Error(0, "_").fileName;
        if ("undefined" != typeof document && document.getElementsByTagName) {
          if ($ = document.baseURI, !$) {
            var N = document.getElementsByTagName("base");
            $ = N[0] && N[0].href || window.location.href;
          }
        } else
        ...
        if ($)
          ...
          $ = "file://" + (D ? "/" : "") + process.cwd() + "/", D && ($ = $.replace(/\\/g, "/"));
        }
        try {
        ...
        !function() {
          ...
          function s(e) {
            g || (g = document.head || document.body || document.documentElement);
            ...
            }, a(this, e), e.metadata.integrity && r.setAttribute("integrity", e.metadata.integrity), e.metadata.nonce && r.setAttribute("nonce", e.metadata.nonce), g.appendChild(r), g.removeChild(r), o(), window.onerror = s, i)
              throw i;
          }
          ...
          var h = !1;
          F && "undefined" != typeof document && document.getElementsByTagName && (window.chrome && window.chrome.extension || navigator.userAgent.match(/^Node\.js/) || (h = !0));
          var g;
        }();
        var te;
        s(function(e) {
          ...
          if ("loaderErrorStack" in e && (ae = $__curScript, e.loaderErrorStack ? $__curScript = void 0 : $__curScript = ae), "warnings" in e && (n.warnings = e.warnings), e.transpilerRuntime === !1 && (n._loader.loadedTranspilerRuntime = !0), ("production" in e || "build" in e) && E.call(n, !!e.production, !!(e.build || te && te.build)), !t) {
            ...
            if (e.paths && g(n.paths, e.paths), O(n, e, function(e) {
              ...
              for (var o in n.paths)
                o.indexOf("*") != -1 && w.call(n, 'Paths configuration "' + o + '" -> "' + n.paths[o] + '" uses wildcards which are being deprecated for just leaving a trailing "/" to indicate folder paths.');
          }
          if (e.defaultJSExtensions && (n.defaultJSExtensions = e.defaultJSExtensions, w.call(n, "The defaultJSExtensions configuration option is deprecated, use packages configuration instead.")), e.pluginFirst && (n.pluginFirst = e.pluginFirst), e.map)
            for (var o in e.map) {
              ...
              if ("string" != typeof i) {
                ...
                u && n.packages[u].main && (l = l.substr(0, l.length - n.packages[u].main.length - 1));
          ...
          if (e.bundles)
            for (var o in e.bundles) {
              for (var b = [],
                ...
                s && ".js" == x.substr(x.length - 3, 3) && (x = x.substr(0, x.length - 3)), b.push(x);
              }
              n.bundles[o] = b;
            }
          if (e.packages)
            for (var o in e.packages) {
              ...
              var l = P.call(n, o);
              "/" == l[l.length - 1] && (l = l.substr(0, l.length - 1)), y(n, l, e.packages[o], !1);
            }
          for (var S in e) {
            var i = e[S];
            if (U.call(["baseURL", "map", "packages", "bundles", "paths", "warnings", "packageConfigPaths", "loaderErrorStack", "browserConfig", "nodeConfig", "devConfig", "buildConfig", "productionConfig"], S) == -1)
              if ("object" != typeof i || i instanceof Array)
                ...
                for (var o in i)
                  if ("meta" == S && "*" == o[0])
                    ...
                    var j = P.call(n, o);
                    n.defaultJSExtensions && ".js" != j.substr(j.length - 3, 3) && !d(j) && (j += ".js"), g(n[S][j] = n[S][j] || {}, i[o]);
                  } else if ("depCache" == S) {
                    var s = n.defaultJSExtensions && ".js" != o.substr(o.length - 3, 3),
                        l = n.decanonicalize(o);
                    s && ".js" == l.substr(l.length - 3, 3) && (l = l.substr(0, l.length - 3)), n[S][l] = [].concat(i[o]);
                  } else
                    n[S][o] = i[o];
              }
          }
