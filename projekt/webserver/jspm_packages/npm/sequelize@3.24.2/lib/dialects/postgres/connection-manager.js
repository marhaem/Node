...
ConnectionManager.prototype.connect = function(config) {
  ...
  connectionConfig = Utils._.pick(config, ['user', 'password', 'host', 'database', 'port']);
  if (config.dialectOptions) {
    Utils._.merge(connectionConfig, Utils._.pick(config.dialectOptions, ['application_name', 'ssl', 'client_encoding', 'binary']));
  }
