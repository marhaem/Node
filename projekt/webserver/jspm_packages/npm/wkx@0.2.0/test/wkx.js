...
(function(Buffer) {
  ...
  var tests = {
    '2D': require('./testdata.json!systemjs-json'),
    'Z': require('./testdataZ.json!systemjs-json'),
    'M': require('./testdataM.json!systemjs-json'),
    'ZM': require('./testdataZM.json!systemjs-json')
  };
