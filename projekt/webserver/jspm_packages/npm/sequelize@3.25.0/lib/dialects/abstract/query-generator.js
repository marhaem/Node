              ...
              if (subQuery && include.required) {
                ...
                (function(include) {
                  ...
                  if (topInclude.through && Object(topInclude.through.model) === topInclude.through.model) {
                    ...
                    var join = [self.quoteTable(topParent.model.name) + '.' + self.quoteIdentifier(isBelongsTo ? topInclude.association.identifierField : topParent.model.primaryKeyAttributes[0]), self.quoteIdentifier(topInclude.model.name) + '.' + self.quoteIdentifier(isBelongsTo ? topParent.model.primaryKeyAttributes[0] : topInclude.association.identifierField)].join(' = ');
