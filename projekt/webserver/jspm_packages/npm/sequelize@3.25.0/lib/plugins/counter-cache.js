...
var CounterCache = function(association, options) {
  ...
  if (this.as) {
    ...
    this.columnName = Utils.camelizeIf(this.as, !this.source.options.underscored);
  }
...
CounterCache.prototype.injectAttributes = function() {
  ...
  newAttributes[this.columnName] = {
    ...
    allowNull: false,
    defaultValue: Utils._.partial(Utils.toDefaultValue, 0)
  };
...
CounterCache.prototype.injectHooks = function() {
  ...
  CounterUtil = {
    update: function(targetId, options) {
      ...
      return association.target.count({
        where: query,
        ...
        return association.source.update(newValues, {
          where: query,
          logging: options && options.logging
        });
      });
    ...
    increment: function(targetId, options) {
      ...
      return association.source.find({
        where: query,
        logging: options && options.logging
      }).then(function(instance) {
        return instance.increment(counterCacheInstance.columnName, {
          by: 1,
          logging: options && options.logging
        });
      });
    ...
    decrement: function(targetId, options) {
      ...
      return association.source.find({
        ...
        return instance.decrement(counterCacheInstance.columnName, {
          by: 1,
          logging: options && options.logging
        });
      });
