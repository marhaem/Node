...
(function(process) {
  ...
  internals.annotate = function() {
    ...
    let message = internals.safeStringify(obj, 2).replace(replacers.key, ($0, $1) => '" \u001b[31m[' + $1 + ']\u001b[0m').replace(replacers.missing, ($0, $1, $2) => '\u001b[41m"' + $1 + '"\u001b[0m\u001b[31m [' + $2 + ']: -- missing --\u001b[0m').replace(replacers.arrayIndex, ($0, $1, $2) => '\n' + $2 + ' \u001b[31m[' + $1 + ']\u001b[0m').replace(replacers.specials, ($0, $1) => $1);
    message = message + '\n\u001b[31m';
