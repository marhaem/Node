...
describe('Request', () => {
  ...
  it('sets referrer', (done) => {
    ...
    server.inject({
      url: '/',
      headers: {referrer: 'http://site.com'}
    }, (res) => {
  ...
  it('generates unique request id', (done) => {
    ...
    const server = new Hapi.Server();
    server.connection();
    server.connections[0]._requestCounter = {
      value: 10,
      min: 10,
      max: 11
    };
