...
describe('authentication', () => {
  ...
  describe('default()', () => {
    it('sets default', (done) => {
      ...
      expect(server.connections[0].auth.settings.default).to.equal({
        strategies: ['default'],
        mode: 'required'
      });
      const handler = function(request, reply) {
  ...
  describe('authenticate()', () => {
    ...
    it('tries to authenticate a request', (done) => {
      const handler = function(request, reply) {
        return reply({
          status: request.auth.isAuthenticated,
      ...
      server.inject('/', (res1) => {
        ...
        server.inject({
          url: '/',
          headers: {authorization: 'Custom john'}
        }, (res2) => {
          expect(res2.statusCode).to.equal(200);
    ...
    it('returns a non Error error response', (done) => {
      ...
      server.inject({
        url: '/',
        headers: {authorization: 'Custom message'}
      }, (res) => {
        expect(res.statusCode).to.equal(200);
    ...
    it('matches multiple required dynamic scopes', (done) => {
      ...
      server.route({
        ...
        config: {
          ...
          auth: {scope: ['+one-{params.id}', '+{params.id}']}
        }
      });
      server.inject({
        url: '/test',
    ...
    it('matches dynamic scope with multiple parts (single to single)', (done) => {
      ...
      server.route({
        ...
        config: {
          ...
          auth: {scope: 'one-{params.id}-{params.role}'}
        }
      });
      server.inject({
        url: '/test/admin',
    ...
    it('validates required scope', (done) => {
      ...
      server.connection();
      server.auth.scheme('custom', internals.implementation);
      server.auth.strategy('default', 'custom', true, {users: {
          steve: {scope: ['a', 'b']},
          john: {scope: ['a', 'b', 'c']}
        }});
      server.route({
    ...
    it('validates complex scope', (done) => {
      ...
      server.inject({
        ...
        server.inject({
          ...
          server.inject({
            url: '/',
            headers: {authorization: 'Custom mary'}
          }, (res3) => {
            expect(res3.statusCode).to.equal(200);
            server.inject({
              url: '/',
              headers: {authorization: 'Custom lucy'}
            }, (res4) => {
              expect(res4.statusCode).to.equal(403);
              expect(res4.result.message).to.equal('Insufficient scope');
              server.inject({
                url: '/',
                headers: {authorization: 'Custom larry'}
              }, (res5) => {
    ...
    it('matches scope (access array)', (done) => {
      ...
      server.route({
        ...
        config: {
          handler: handler,
          auth: {access: [{scope: 'other'}, {scope: 'one'}]}
        }
      });
      server.inject({
        url: '/',
    ...
    it('errors on matching scope (access array)', (done) => {
      ...
      server.route({
        ...
        config: {
          handler: handler,
          auth: {access: [{scope: 'two'}, {scope: 'three'}, {
              entity: 'user',
              scope: 'one'
            }, {
              entity: 'app',
    ...
    it('errors on missing user entity', (done) => {
      ...
      server.inject({
        url: '/',
        headers: {authorization: 'Custom client'}
      }, (res) => {
        expect(res.statusCode).to.equal(403);
  ...
  describe('payload()', () => {
    it('authenticates request payload', (done) => {
      ...
      server.route({
        ...
        config: {
          ...
          auth: {payload: 'required'}
        }
      });
      server.inject({
        method: 'POST',
        url: '/',
        headers: {authorization: 'Custom validPayload'}
      }, (res) => {
        expect(res.statusCode).to.equal(200);
        done();
      });
    ...
    it('skips when scheme does not support it', (done) => {
      ...
      server.auth.scheme('custom', internals.implementation);
      server.auth.strategy('default', 'custom', true, {
        users: {validPayload: {payload: null}},
        payload: false
      });
      server.route({
        method: 'POST',
    ...
    it('skips request payload by default', (done) => {
      ...
      server.inject({
        method: 'POST',
        url: '/',
        headers: {authorization: 'Custom skip'}
      }, (res) => {
        expect(res.statusCode).to.equal(200);
        done();
      });
    ...
    it('skips optional payload', (done) => {
      ...
      server.inject({
        method: 'POST',
        url: '/',
        headers: {authorization: 'Custom optionalPayload'}
      }, (res) => {
        expect(res.statusCode).to.equal(200);
        done();
      });
    ...
    it('errors on invalid request payload (non error)', (done) => {
      ...
      server.inject({
        method: 'POST',
        url: '/',
        headers: {authorization: 'Custom invalidPayload'}
      }, (res) => {
        expect(res.statusCode).to.equal(200);
...
internals.implementation = function(server, options) {
  ...
  if (!settings || settings.payload !== false) {
