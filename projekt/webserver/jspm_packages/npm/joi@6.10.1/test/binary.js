...
(function(Buffer) {
  ...
  describe('binary', function() {
    ...
    it('validates allowed buffer content', function(done) {
      ...
      Helper.validate(schema, [['hello', true], [hello, true], [new Buffer('hello'), true], ['goodbye', false], [new Buffer('goodbye'), false], [new Buffer('HELLO'), false]], done);
    });
    ...
    describe('#min', function() {
      it('validates buffer size', function(done) {
        ...
        Helper.validate(schema, [[new Buffer('testing'), true], [new Buffer('test'), false]], done);
      });
    ...
    describe('#max', function() {
      it('validates buffer size', function(done) {
        ...
        Helper.validate(schema, [[new Buffer('testing'), false], [new Buffer('test'), true]], done);
      });
    ...
    describe('#length', function() {
      it('validates buffer size', function(done) {
        ...
        Helper.validate(schema, [[new Buffer('test'), true], [new Buffer('testing'), false]], done);
      });
