...
describe('func', function() {
  it('validates a function', function(done) {
    Helper.validate(Joi.func().required(), [[function() {}, true], ['', false]], done);
  });
  it('validates a function with keys', function(done) {
    ...
    var b = function() {};
    b.a = 123;
    Helper.validate(Joi.func().keys({a: Joi.string().required()}).required(), [[function() {}, false], [a, true], [b, false], ['', false]], done);
  });
