...
describe('ref', function() {
  it('uses ref as a valid value', function(done) {
    ...
    schema.validate({
      ...
      Helper.validate(schema, [[{a: 5}, false], [{b: 5}, true], [{
        a: 5,
        b: 5
      }, true], [{
        a: '5',
  ...
  it('uses ref as a valid value (empty key)', function(done) {
    ...
    schema.validate({
      ...
      Helper.validate(schema, [[{a: 5}, false], [{'': 5}, true], [{
        a: 5,
        '': 5
      }, true], [{
        a: '5',
  ...
  it('uses ref with nested keys as a valid value', function(done) {
    ...
    schema.validate({
      ...
      Helper.validate(schema, [[{a: 5}, false], [{b: {c: 5}}, true], [{
        a: 5,
        b: 5
      }, false], [{
        a: '5',
  ...
  it('uses ref with combined nested keys in sub child', function(done) {
    ...
    schema.validate(input, function(err, value) {
      ...
      var parent = Joi.object({e: schema});
  ...
  it('uses context as a valid value', function(done) {
    ...
    Joi.validate({
      a: 5,
      b: 6
    }, schema, {context: {x: 22}}, function(err, value) {
      expect(err).to.exist();
      expect(err.message).to.equal('child "a" fails because ["a" must be one of [context:x]]');
      Helper.validateOptions(schema, [[{a: 5}, false], [{a: 22}, true], [{b: 5}, true], [{
        a: 22,
        b: 5
      }, true], [{
        a: '22',
        b: '5'
      }, false]], {context: {x: 22}}, done);
    });
  });
  it('uses context in when condition', function(done) {
    var schema = {a: Joi.boolean().when('$x', {
        is: Joi.exist(),
        otherwise: Joi.forbidden()
      })};
    Helper.validate(schema, [[{}, true], [{a: 'x'}, false], [{a: true}, false], [{}, true, {context: {}}], [{a: 'x'}, false, {context: {}}], [{a: true}, false, {context: {}}], [{}, true, {context: {x: 1}}], [{a: 'x'}, false, {context: {x: 1}}], [{a: true}, true, {context: {x: 1}}]], done);
  });
  it('uses nested context in when condition', function(done) {
    var schema = {a: Joi.boolean().when('$x.y', {
        is: Joi.exist(),
        otherwise: Joi.forbidden()
      })};
    Helper.validate(schema, [[{}, true], [{a: 'x'}, false], [{a: true}, false], [{}, true, {context: {}}], [{a: 'x'}, false, {context: {}}], [{a: true}, false, {context: {}}], [{}, true, {context: {x: 1}}], [{a: 'x'}, false, {context: {x: 1}}], [{a: true}, false, {context: {x: 1}}], [{}, true, {context: {x: {}}}], [{a: 'x'}, false, {context: {x: {}}}], [{a: true}, false, {context: {x: {}}}], [{}, true, {context: {x: {y: 1}}}], [{a: 'x'}, false, {context: {x: {y: 1}}}], [{a: true}, true, {context: {x: {y: 1}}}]], done);
  });
