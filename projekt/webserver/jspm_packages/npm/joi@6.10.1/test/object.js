...
describe('object', function() {
  ...
  it('validates an object', function(done) {
    ...
    Helper.validate(schema, [[{}, true], [{hi: true}, true], ['', false]], done);
  });
  it('return object reference when no rules specified', function(done) {
    var schema = Joi.object({a: Joi.object()});
    var item = {x: 5};
  ...
  it('should prevent extra keys from existing by default', function(done) {
    ...
    Helper.validate(schema, [[{item: 'something'}, true], [{
      item: 'something',
  ...
  it('should validate count when min is set', function(done) {
    ...
    Helper.validate(schema, [[{item: 'something'}, false], [{
      item: 'something',
      item2: 'something else'
    }, false], [{
      item: 'something',
  ...
  it('should validate constructor when type is set', function(done) {
    ...
    Helper.validate(schema, [[{item: 'something'}, false], ['', false], [new Date(), false], [/abcd/, true], [new RegExp(), true]], done);
  });
  it('should traverse an object and validate all properties in the top level', function(done) {
    var schema = Joi.object({num: Joi.number()});
    Helper.validate(schema, [[{num: 1}, true], [{num: [1, 2, 3]}, false]], done);
  });
  it('should traverse an object and child objects and validate all properties', function(done) {
    var schema = Joi.object({
      num: Joi.number(),
      obj: Joi.object({item: Joi.string()})
    });
    Helper.validate(schema, [[{num: 1}, true], [{num: [1, 2, 3]}, false], [{
      num: 1,
      obj: {item: 'something'}
    }, true], [{
      num: 1,
  ...
  it('should traverse an object several levels', function(done) {
    var schema = Joi.object({obj: Joi.object({obj: Joi.object({obj: Joi.object({item: Joi.boolean()})})})});
    Helper.validate(schema, [[{num: 1}, false], [{obj: {}}, true], [{obj: {obj: {}}}, true], [{obj: {obj: {obj: {}}}}, true], [{obj: {obj: {obj: {item: true}}}}, true], [{obj: {obj: {obj: {item: 10}}}}, false]], done);
  });
  it('should traverse an object several levels with required levels', function(done) {
    var schema = Joi.object({obj: Joi.object({obj: Joi.object({obj: Joi.object({item: Joi.boolean()})}).required()})});
    Helper.validate(schema, [[null, false], [undefined, true], [{}, true], [{obj: {}}, false], [{obj: {obj: {}}}, true], [{obj: {obj: {obj: {}}}}, true], [{obj: {obj: {obj: {item: true}}}}, true], [{obj: {obj: {obj: {item: 10}}}}, false]], done);
  });
  it('should traverse an object several levels with required levels (without Joi.obj())', function(done) {
    var schema = {obj: {obj: {obj: {item: Joi.boolean().required()}}}};
    Helper.validate(schema, [[null, false], [undefined, true], [{}, true], [{obj: {}}, true], [{obj: {obj: {}}}, true], [{obj: {obj: {obj: {}}}}, false], [{obj: {obj: {obj: {item: true}}}}, true], [{obj: {obj: {obj: {item: 10}}}}, false]], done);
  });
  ...
  it('validates both valid() and with()', function(done) {
    ...
    Helper.validate(schema, [[{first: 'value'}, false]], done);
  });
  it('validates referenced arrays in valid()', function(done) {
    var schema = Joi.object({foo: Joi.valid(Joi.ref('$x'))});
    Helper.validate(schema, [[{foo: 'bar'}, true, {context: {x: 'bar'}}], [{foo: 'bar'}, true, {context: {x: ['baz', 'bar']}}], [{foo: 'bar'}, false, {context: {x: 'baz'}}], [{foo: 'bar'}, false, {context: {x: ['baz', 'qux']}}], [{foo: 'bar'}, false]], done);
  });
  ...
  it('should work on prototype-less objects', function(done) {
    ...
    var schema = Joi.object().keys({a: Joi.number()});
    input.a = 1337;
  ...
  describe('#keys', function() {
    ...
    it('overrides existing keys', function(done) {
      ...
      Helper.validate(a, [[{a: 1}, true, null, {a: 1}], [{a: '1'}, true, null, {a: 1}], [{a: '2'}, false, null, 'child "a" fails because ["a" must be one of [1]]']], function() {
        Helper.validate(b, [[{a: 1}, false, null, 'child "a" fails because ["a" must be a string]'], [{a: '1'}, true, null, {a: '1'}]], done);
      });
    });
    ...
    it('should strip from an alternative', function(done) {
      var schema = Joi.object({a: [Joi.boolean().strip()]});
      var valid = {a: true};
      schema.validate(valid, function(err, value) {
        expect(err).to.not.exist();
  ...
  describe('#unknown', function() {
    it('allows local unknown without applying to children', function(done) {
      var schema = Joi.object({a: {b: Joi.number()}}).unknown();
      Helper.validate(schema, [[{a: {b: 5}}, true], [{a: {b: 'x'}}, false], [{
        a: {b: 5},
        c: 'ignore'
      }, true], [{a: {
          b: 5,
    ...
    it('forbids local unknown without applying to children', function(done) {
      var schema = Joi.object({a: Joi.object({b: Joi.number()}).unknown()}).options({allowUnknown: false});
      Helper.validate(schema, [[{a: {b: 5}}, true], [{a: {b: 'x'}}, false], [{
        a: {b: 5},
        c: 'ignore'
      }, false], [{a: {
  ...
  describe('#rename', function() {
    it('allows renaming multiple times with multiple enabled', function(done) {
      var schema = Joi.object({test: Joi.string()}).rename('test1', 'test').rename('test2', 'test', {multiple: true});
      Joi.compile(schema).validate({
        test1: 'a',
        test2: 'b'
      }, function(err, value) {
        expect(err).to.not.exist();
    ...
    it('errors renaming multiple times with multiple disabled', function(done) {
      var schema = Joi.object({test: Joi.string()}).rename('test1', 'test').rename('test2', 'test');
      Joi.compile(schema).validate({
        test1: 'a',
        test2: 'b'
      }, function(err, value) {
    ...
    it('with override disabled should not allow overwriting existing value', function(done) {
      var schema = Joi.object({test1: Joi.string()}).rename('test', 'test1');
      schema.validate({
        test: 'b',
        test1: 'a'
      }, function(err, value) {
    ...
    it('with override enabled should allow overwriting existing value', function(done) {
      var schema = Joi.object({test1: Joi.string()}).rename('test', 'test1', {override: true});
      schema.validate({
        test: 'b',
        test1: 'a'
      }, function(err, value) {
    ...
    it('renames when data is nested in an array via items', function(done) {
      var schema = {arr: Joi.array().items(Joi.object({
          one: Joi.string(),
          two: Joi.string()
    ...
    it('applies rename and validation in the correct order regardless of key order', function(done) {
      var schema1 = Joi.object({a: Joi.number()}).rename('b', 'a');
      var input1 = {b: '5'};
    ...
    it('sets the default value after key is renamed', function(done) {
      var schema = Joi.object({foo2: Joi.string().default('test')}).rename('foo', 'foo2');
      var input = {};
  ...
  describe('#describe', function() {
    it('return empty description when no schema defined', function(done) {
      ...
      expect(desc).to.deep.equal({type: 'object'});
      done();
    });
    it('respects the shallow parameter', function(done) {
      var schema = Joi.object({
        name: Joi.string(),
        child: Joi.object({name: Joi.string()})
      });
    ...
    it('describes patterns', function(done) {
      var schema = Joi.object({a: Joi.string()}).pattern(/\w\d/i, Joi.boolean());
  ...
  describe('#pattern', function() {
    it('shows path to errors in schema', function(done) {
      expect(function() {
        Joi.object().pattern(/.*/, {a: {b: {c: {d: undefined}}}});
    ...
    it('validates unknown keys using a pattern', function(done) {
      var schema = Joi.object({a: Joi.number()}).pattern(/\d+/, Joi.boolean()).pattern(/\w\w+/, 'x');
      Joi.validate({
        bb: 'y',
        5: 'x'
        ...
        Helper.validate(schema, [[{a: 5}, true], [{a: 'x'}, false], [{b: 'x'}, false], [{bb: 'x'}, true], [{5: 'x'}, false], [{5: false}, true], [{5: undefined}, true]], done);
      });
    });
    it('validates unknown keys using a pattern (nested)', function(done) {
      var schema = {x: Joi.object({a: Joi.number()}).pattern(/\d+/, Joi.boolean()).pattern(/\w\w+/, 'x')};
      Joi.validate({x: {
          bb: 'y',
          5: 'x'
        }}, schema, {abortEarly: false}, function(err, value) {
  ...
  describe('#or', function() {
    ...
    it('errors multiple levels deep', function(done) {
      Joi.object({a: {b: Joi.object().or('x', 'y')}}).validate({a: {b: {c: 1}}}, function(err, value) {
        expect(err).to.exist();
        expect(err.details[0].path).to.equal('a.b');
  ...
  describe('#assert', function() {
    it('shows path to errors in schema', function(done) {
      expect(function() {
        Joi.object().assert('a.b', {a: {b: {c: {d: undefined}}}});
      }).to.throw(Error, 'Invalid schema content: (a.b.c.d)');
      done();
    });
    ...
    it('provides a default message for failed assertions', function(done) {
      ...
      schema.validate({d: {e: []}}, function(err) {
        expect(err).to.exist();
  ...
  describe('#type', function() {
    ...
    it('uses the constructor name in the schema description', function(done) {
      ...
      expect(description.rules).to.deep.include({
        name: 'type',
        arg: 'RegExp'
      });
      done();
