...
describe('number', function() {
  ...
  describe('#validate', function() {
    it('should, by default, allow undefined', function(done) {
      Helper.validate(Joi.number(), [[undefined, true]], done);
    });
    it('should, when .required(), deny undefined', function(done) {
      Helper.validate(Joi.number().required(), [[undefined, false]], done);
    });
    ...
    it('should validate integer', function(done) {
      ...
      Helper.validate(t, [[100, true], [0, true], [null, false], [1.02, false], [0.01, false]], done);
    });
    it('should return false for Infinity', function(done) {
      var t = Joi.number();
      Helper.validate(t, [[Infinity, false], [-Infinity, false]], done);
    });
    it('should return true for allowed Infinity', function(done) {
      var t = Joi.number().allow(Infinity, -Infinity);
      Helper.validate(t, [[Infinity, true], [-Infinity, true]], done);
    });
    it('can accept string numbers', function(done) {
      var t = Joi.number();
      Helper.validate(t, [['1', true], ['100', true], ['1e3', true], ['1 some text', false], ['\t\r', false], [' ', false], [' 2', true], ['\t\r43', true], ['43 ', true], ['', false]], done);
    });
    it('required validates correctly', function(done) {
      var t = Joi.number().required();
      Helper.validate(t, [[NaN, false], ['100', true]], done);
    });
    ...
    it('should handle combination of positive, allow, and null allowed', function(done) {
      ...
      Helper.validate(rule, [[1, true], [-1, true], [8, true], [-10, false], [null, true]], done);
    });
    it('should handle combination of negative, allow, and null allowed', function(done) {
      ...
      Helper.validate(rule, [[1, true], [-10, true], [8, false], [0, false], [null, true]], done);
    });
    it('should handle combination of positive, allow, null allowed, and invalid', function(done) {
      ...
      Helper.validate(rule, [[1, false], [-1, true], [8, true], [-10, false], [null, true]], done);
    });
    it('should handle combination of negative, allow, null allowed, and invalid', function(done) {
      ...
      Helper.validate(rule, [[1, true], [-10, true], [-5, false], [8, false], [0, false], [null, true]], done);
    });
    it('should handle combination of min, max, and allow', function(done) {
      var rule = Joi.number().min(8).max(10).allow(1);
      Helper.validate(rule, [[1, true], [11, false], [8, true], [9, true], [null, false]], done);
    });
    it('should handle combination of min, max, allow, and null allowed', function(done) {
      ...
      Helper.validate(rule, [[1, true], [11, false], [8, true], [9, true], [null, true]], done);
    });
    it('should handle combination of min, max, allow, and invalid', function(done) {
      ...
      Helper.validate(rule, [[1, true], [11, false], [8, true], [9, false], [null, false]], done);
    });
    it('should handle combination of min, max, allow, invalid, and null allowed', function(done) {
      ...
      Helper.validate(rule, [[1, true], [11, false], [8, true], [9, false], [null, true]], done);
    });
    it('should handle combination of min, max, and integer', function(done) {
      var rule = Joi.number().min(8).max(10).integer();
      Helper.validate(rule, [[1, false], [11, false], [8, true], [9, true], [9.1, false], [null, false]], done);
    });
    it('should handle combination of min, max, integer, and allow', function(done) {
      ...
      Helper.validate(rule, [[1, false], [11, false], [8, true], [9, true], [9.1, true], [9.2, false], [null, false]], done);
    });
    it('should handle combination of min, max, integer, allow, and invalid', function(done) {
      ...
      Helper.validate(rule, [[1, false], [11, false], [8, false], [9, true], [9.1, true], [9.2, false], [null, false]], done);
    });
    it('should handle combination of min, max, integer, allow, invalid, and null allowed', function(done) {
      ...
      Helper.validate(rule, [[1, false], [11, false], [8, false], [9, true], [9.1, true], [9.2, false], [null, true]], done);
    });
    it('should handle limiting the number of decimal places', function(done) {
      ...
      Helper.validate(rule, [[1, true], [9.1, true], [9.21, false], [9.9999, false], [9.999e99, true], [9.9e-99, false], [9.9e3, true], [null, false]], done);
    });
    it('should handle combination of min, max, integer, allow, invalid, null allowed and precision', function(done) {
      ...
      Helper.validate(rule, [[1, false], [11, false], [8, false], [9, true], [9.1, true], [9.11, false], [9.2, false], [9.22, false], [null, true]], done);
    });
    it('should handle combination of greater and less', function(done) {
      var rule = Joi.number().greater(5).less(10);
      Helper.validate(rule, [[0, false], [11, false], [5, false], [10, false], [8, true], [5.01, true], [9.99, true], [null, false]], done);
    });
    it('should handle combination of greater, less, and integer', function(done) {
      var rule = Joi.number().integer().greater(5).less(10);
      Helper.validate(rule, [[0, false], [11, false], [5, false], [10, false], [6, true], [9, true], [5.01, false], [9.99, false]], done);
    });
    it('should handle combination of greater, less, and null allowed', function(done) {
      ...
      Helper.validate(rule, [[0, false], [11, false], [5, false], [10, false], [8, true], [5.01, true], [9.99, true], [null, true]], done);
    });
    it('should handle combination of greater, less, invalid, and allow', function(done) {
      ...
      Helper.validate(rule, [[0, false], [11, false], [5, false], [10, false], [6, false], [8, true], [5.01, true], [9.99, true], [-3, true], [null, false]], done);
    });
  });
  ...
  describe('#min', function() {
    ...
    it('accepts references as min value', function(done) {
      ...
      Helper.validate(schema, [[{
        ...
        a: '1337',
        b: 42
      }, false, null, 'child "b" fails because ["b" must be larger than or equal to 1337]'], [{
        a: 2.4,
        b: 4.2
      }, true], [{
        a: 4.2,
        ...
        a: 4.2,
        b: 2.4
      }, false, null, 'child "b" fails because ["b" must be larger than or equal to 4.2]']], done);
    });
    it('accepts context references as min value', function(done) {
      var schema = Joi.object({b: Joi.number().min(Joi.ref('$a'))});
      Helper.validate(schema, [[{b: 1337}, true, {context: {a: 42}}], [{b: 42}, false, {context: {a: 1337}}], [{b: 4.2}, true, {context: {a: 2.4}}], [{b: 4.20000001}, true, {context: {a: 4.2}}], [{b: 4.2}, false, {context: {a: 4.20000001}}], [{b: 2.4}, false, {context: {a: 4.2}}, 'child "b" fails because ["b" must be larger than or equal to 4.2]']], done);
    });
    ...
    it('errors if context reference is not a number', function(done) {
      var schema = Joi.object({b: Joi.number().min(Joi.ref('$a'))});
      Helper.validate(schema, [[{b: 42}, false, {context: {a: 'abc'}}, 'child "b" fails because ["b" references "a" which is not a number]']], done);
    });
  });
  describe('#max', function() {
    ...
    it('accepts references as max value', function(done) {
      ...
      Helper.validate(schema, [[{
        ...
        a: '42',
        b: 1337
      }, false, null, 'child "b" fails because ["b" must be less than or equal to 42]'], [{
        a: 4.2,
        b: 2.4
      }, true], [{
        a: 4.2,
        ...
        a: 2.4,
        b: 4.2
      }, false, null, 'child "b" fails because ["b" must be less than or equal to 2.4]']], done);
    });
    it('accepts context references as max value', function(done) {
      var schema = Joi.object({b: Joi.number().max(Joi.ref('$a'))});
      Helper.validate(schema, [[{b: 42}, true, {context: {a: 1337}}], [{b: 1337}, false, {context: {a: 42}}], [{b: 2.4}, true, {context: {a: 4.2}}], [{b: 4.20000001}, false, {context: {a: 4.2}}], [{b: 4.2}, true, {context: {a: 4.20000001}}], [{b: 4.2}, false, {context: {a: 2.4}}, 'child "b" fails because ["b" must be less than or equal to 2.4]']], done);
    });
    it('errors if reference is not a number', function(done) {
      var schema = Joi.object({
        a: Joi.string(),
  ...
  describe('#less', function() {
    ...
    it('accepts references as less value', function(done) {
      ...
      Helper.validate(schema, [[{
        ...
        a: '42',
        b: 1337
      }, false, null, 'child "b" fails because ["b" must be less than 42]'], [{
        a: 4.2,
        b: 2.4
      }, true], [{
        a: 4.2,
        ...
        a: 2.4,
        b: 4.2
      }, false, null, 'child "b" fails because ["b" must be less than 2.4]']], done);
    });
    it('accepts context references as less value', function(done) {
      var schema = Joi.object({b: Joi.number().less(Joi.ref('$a'))});
      Helper.validate(schema, [[{b: 42}, true, {context: {a: 1337}}], [{b: 1337}, false, {context: {a: 42}}], [{b: 2.4}, true, {context: {a: 4.2}}], [{b: 4.20000001}, false, {context: {a: 4.2}}], [{b: 4.2}, true, {context: {a: 4.20000001}}], [{b: 4.2}, false, {context: {a: 2.4}}, 'child "b" fails because ["b" must be less than 2.4]']], done);
    });
    it('errors if reference is not a number', function(done) {
      var schema = Joi.object({
        a: Joi.string(),
  ...
  describe('#greater', function() {
    ...
    it('accepts references as greater value', function(done) {
      ...
      Helper.validate(schema, [[{
        ...
        a: '1337',
        b: 42
      }, false, null, 'child "b" fails because ["b" must be greater than 1337]'], [{
        a: 2.4,
        b: 4.2
      }, true], [{
        a: 4.2,
        ...
        a: 4.2,
        b: 2.4
      }, false, null, 'child "b" fails because ["b" must be greater than 4.2]']], done);
    });
    it('accepts context references as greater value', function(done) {
      var schema = Joi.object({b: Joi.number().greater(Joi.ref('$a'))});
      Helper.validate(schema, [[{b: 1337}, true, {context: {a: 42}}], [{b: 42}, false, {context: {a: 1337}}], [{b: 4.2}, true, {context: {a: 2.4}}], [{b: 4.20000001}, true, {context: {a: 4.2}}], [{b: 4.2}, false, {context: {a: 4.20000001}}], [{b: 2.4}, false, {context: {a: 4.2}}, 'child "b" fails because ["b" must be greater than 4.2]']], done);
    });
    it('errors if reference is not a number', function(done) {
      var schema = Joi.object({
        a: Joi.string(),
  ...
  describe('#precision', function() {
    it('converts numbers', function(done) {
      ...
      Helper.validate(rule, [[1.5, true, null, 1.5], [0.12345, true, null, 0.1235], [123456, true, null, 123456], [123456.123456, true, null, 123456.1235], ['123456.123456', true, null, 123456.1235], ['abc', false], [NaN, false]], done);
    });
  });
  ...
  describe('#multiple', function() {
    ...
    it('should handle multiples correctly', function(done) {
      ...
      Helper.validate(rule, [[0, true], [3, true], [4, false], [9, true], ['a', false], [9.1, false], [8.9, false]], done);
    });
  });
});
