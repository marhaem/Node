...
describe('Joi', function() {
  ...
  it('keeps schema immutable', function(done) {
    var a = Joi.string();
    var b = a.valid('b');
    Helper.validate(a, [['a', true], ['b', true], [5, false]], function() {
      Helper.validate(b, [['a', false], ['b', true], [5, false]], done);
    });
  });
  ...
  it('validates null schema', function(done) {
    Helper.validate(null, [['a', false], [null, true]], done);
  });
  it('validates number literal', function(done) {
    Helper.validate(5, [[6, false], [5, true]], done);
  });
  it('validates string literal', function(done) {
    Helper.validate('5', [['6', false], ['5', true]], done);
  });
  it('validates boolean literal', function(done) {
    Helper.validate(true, [[false, false], [true, true]], done);
  });
  it('validates date literal', function(done) {
    var now = Date.now();
    Helper.validate(new Date(now), [[new Date(now), true], [now, true], [now * 2, false]], done);
  });
  it('validates complex literal', function(done) {
    ...
    Helper.validate(schema, [['key', true], [5, true], ['other', false], [6, false], [{c: 5}, false], [{}, true], [{b: 'abc'}, true], [{
      a: true,
      b: 'boom'
    }, true], [{
      a: 5,
  ...
  it('validated with', function(done) {
    ...
    Joi.validate({txt: 'a'}, schema, {abortEarly: false}, function(err, value) {
      ...
      Helper.validate(schema, [[{upc: 'test'}, true], [{txt: 'test'}, false], [{
        txt: 'test',
        upc: null
      }, false], [{
        txt: 'test',
  ...
  it('validated without', function(done) {
    ...
    Joi.validate({
      ...
      Helper.validate(schema, [[{upc: 'test'}, true], [{txt: 'test'}, true], [{
        txt: 'test',
        upc: null
      }, false], [{
        txt: 'test',
  ...
  it('validates xor', function(done) {
    ...
    Joi.validate({}, schema, {abortEarly: false}, function(err, value) {
      ...
      Helper.validate(schema, [[{upc: null}, false], [{upc: 'test'}, true], [{txt: null}, false], [{txt: 'test'}, true], [{
        txt: 'test',
        upc: null
      }, false], [{
        txt: 'test',
  ...
  it('validates multiple peers xor', function(done) {
    ...
    Helper.validate(schema, [[{upc: 'test'}, true], [{txt: 'test'}, true], [{}, false]], done);
  });
  it('validates xor with number types', function(done) {
    ...
    Helper.validate(schema, [[{upc: 123}, true], [{code: 456}, true], [{
      code: 456,
      upc: 123
    }, false], [{}, false]], done);
  });
  it('validates xor when empty value of peer allowed', function(done) {
    ...
    Helper.validate(schema, [[{upc: ''}, true], [{upc: '123'}, true], [{code: '456'}, true], [{
      code: '456',
      upc: ''
    }, false], [{}, false]], done);
  });
  it('validates or', function(done) {
    ...
    Joi.validate({}, schema, {abortEarly: false}, function(err, value) {
      ...
      Helper.validate(schema, [[{upc: null}, true], [{upc: 'test'}, true], [{txt: null}, false], [{txt: 'test'}, true], [{code: null}, false], [{code: 123}, true], [{
        txt: 'test',
        upc: null
      }, true], [{
        txt: 'test',
  ...
  it('validates and', function(done) {
    ...
    Joi.validate({txt: 'x'}, schema, {abortEarly: false}, function(err, value) {
      ...
      Helper.validate(schema, [[{}, true], [{upc: null}, false], [{upc: 'test'}, false], [{txt: null}, false], [{txt: 'test'}, false], [{code: null}, false], [{code: 123}, false], [{
        txt: 'test',
        upc: null
      }, false], [{
        txt: 'test',
  ...
  it('validates nand()', function(done) {
    ...
    Joi.validate({
      ...
      Helper.validate(schema, [[{}, true], [{upc: null}, true], [{upc: 'test'}, true], [{txt: 'test'}, true], [{code: 123}, true], [{
        txt: 'test',
        upc: null
      }, true], [{
        txt: 'test',
  ...
  it('validates an array of valid types', function(done) {
    var schema = Joi.object({auth: [Joi.object({mode: Joi.string().valid('required', 'optional', 'try').allow(null)}).allow(null), Joi.string(), Joi.boolean()]});
    schema.validate({auth: {mode: 'none'}}, function(err, value) {
      ...
      Helper.validate(schema, [[{auth: {mode: 'try'}}, true], [{something: undefined}, false], [{auth: {something: undefined}}, false], [{auth: null}, true], [{auth: undefined}, true], [{}, true], [{auth: true}, true], [{auth: 123}, false]], done);
    });
  });
  it('validates alternatives', function(done) {
    var schema = Joi.object({auth: Joi.alternatives(Joi.object({mode: Joi.string().valid('required', 'optional', 'try').allow(null)}).allow(null), Joi.string(), Joi.boolean())});
    schema.validate({auth: {mode: 'none'}}, function(err, value) {
      expect(err).to.exist();
      expect(err.message).to.equal('child "auth" fails because [child "mode" fails because ["mode" must be one of [required, optional, try, null]], "auth" must be a string, "auth" must be a boolean]');
      Helper.validate(schema, [[{auth: {mode: 'try'}}, true], [{something: undefined}, false], [{auth: {something: undefined}}, false], [{auth: null}, true], [{auth: undefined}, true], [{}, true], [{auth: true}, true], [{auth: 123}, false]], done);
  ...
  it('validates required alternatives', function(done) {
    var schema = {a: Joi.alternatives(Joi.string().required(), Joi.boolean().required())};
    Helper.validate(schema, [[{a: null}, false], [{a: undefined}, true], [{}, true], [{a: true}, true], [{a: 'true'}, true], [{a: 123}, false], [{a: {c: 1}}, false], [{b: undefined}, false]], done);
  });
  it('validates required [] alternatives', function(done) {
    var schema = {a: [Joi.string().required(), Joi.boolean().required()]};
    Helper.validate(schema, [[{a: null}, false], [{a: undefined}, true], [{}, true], [{a: true}, true], [{a: 'true'}, true], [{a: 123}, false], [{a: {c: 1}}, false], [{b: undefined}, false]], done);
  });
  it('validates an array of string with valid', function(done) {
    var schema = {brand: Joi.array().items(Joi.string().valid('amex', 'visa'))};
    Helper.validate(schema, [[{brand: ['amex']}, true], [{brand: ['visa', 'mc']}, false]], done);
  });
  it('validates pre and post convert value', function(done) {
    var schema = Joi.number().valid(5);
    Helper.validate(schema, [[5, true], ['5', true]], done);
  });
  it('does not change object when validation fails', function(done) {
    var schema = Joi.object({a: Joi.number().valid(2)});
    var obj = {a: '5'};
    schema.validate(obj, function(err, value) {
      expect(err).to.exist();
  ...
  it('does not set optional keys when missing', function(done) {
    var schema = Joi.object({a: Joi.number()});
    var obj = {};
    schema.validate(obj, function(err, value) {
      expect(err).to.not.exist();
  ...
  it('invalidates pre and post convert value', function(done) {
    ...
    Helper.validate(schema, [[5, false], ['5', false]], done);
  });
  ...
  it('validates an unknown option', function(done) {
    var config = {auth: Joi.object({mode: Joi.string().valid('required', 'optional', 'try').allow(null)}).allow(null)};
  ...
  it('validates required key with multiple options', function(done) {
    var config = {module: Joi.alternatives([Joi.object({
  ...
  it('validates key with required alternatives', function(done) {
    var config = {module: Joi.alt().try(Joi.object({
        compile: Joi.func().required(),
        execute: Joi.func()
  ...
  it('validates when parameter is required to be an object and is given correctly as a json string', function(done) {
    var schema = {a: Joi.object({b: Joi.string().required()})};
    var input = {a: '{"b":"string"}'};
  ...
  it('validates missing optional key with string condition', function(done) {
    var schema = {key: Joi.string().alphanum(false).min(8)};
  ...
  it('should not convert values when convert is false', function(done) {
    var schema = {arr: Joi.array().items(Joi.string())};
    var input = {arr: 'foo'};
  ...
  it('errors multiple times when abortEarly is false in a complex object', function(done) {
    var schema = Joi.object({
      ...
      test2: Joi.object({test3: Joi.array().items(Joi.object().keys({
          foo: Joi.string().required().max(3),
          bar: Joi.string().max(5),
          baz: Joi.object({test4: Joi.array().items(Joi.object().keys({
              foo: Joi.string().required().max(3),
              bar: Joi.string().max(5)
            }))})
        }))})
  ...
  describe('#describe', function() {
    ...
    var schema = Joi.object({
      sub: {
        ...
        date: Joi.date(),
        child: Joi.object({alphanum: Joi.string().alphanum()})
      },
    ...
    var result = {
      ...
      children: {
        ...
        defaultRef: {
          type: 'string',
          flags: {default: defaultRef},
          invalids: ['']
        },
        defaultFn: {
          type: 'string',
          flags: {default: defaultFn},
          invalids: ['']
        },
        defaultDescribedFn: {
          type: 'string',
          flags: {default: defaultDescribedFn},
          invalids: ['']
        }
      },
      dependencies: [{
    ...
    it('describes schema (any)', function(done) {
      ...
      expect(description).to.deep.equal({type: 'any'});
      done();
    });
