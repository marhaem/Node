...
describe("WKT Convert", function() {
  ...
  it("should convert a MULTIPOLYGON with Z", function() {
    var input = {
      "type": "MultiPolygon",
      "coordinates": [[[[102.0, 2.0, 1], [103.0, 2.0, 2], [103.0, 3.0, 3], [102.0, 3.0, 4], [102.0, 2.0, 5]]], [[[100.0, 0.0], [101.0, 0.0], [101.0, 1.0], [100.0, 1.0], [100.0, 0.0]], [[100.2, 0.2], [100.8, 0.2], [100.8, 0.8], [100.2, 0.8], [100.2, 0.2]]]]
    };
    var output = Terraformer.WKT.convert(input);
  ...
  it("should convert a MULTIPOLYGON with Z and M", function() {
    var input = {
      "type": "MultiPolygon",
      "coordinates": [[[[102.0, 2.0, 1, 2], [103.0, 2.0, 3, 4], [103.0, 3.0, 5, 6], [102.0, 3.0, 7, 8], [102.0, 2.0, 9, 10]]], [[[100.0, 0.0], [101.0, 0.0], [101.0, 1.0], [100.0, 1.0], [100.0, 0.0]], [[100.2, 0.2], [100.8, 0.2], [100.8, 0.8], [100.2, 0.8], [100.2, 0.2]]]]
    };
    var output = Terraformer.WKT.convert(input);
...
describe("WKT Parser", function() {
  ...
  it("should parse a POLYGON with a hole", function() {
    ...
    var output = new Terraformer.WKT.parse(input);
    expect(output.coordinates).toEqual([[[35, 10], [10, 20], [15, 40], [45, 45], [35, 10]], [[20, 30], [35, 35], [30, 20], [20, 30]]]);
    expect(output).toBeInstanceOfClass(Terraformer.Polygon);
    expect(output.type).toEqual("Polygon");
  });
  ...
  it("should parse a MULTILINESTRING with alternate syntax", function() {
    ...
    var output = new Terraformer.WKT.parse(input);
    expect(output.coordinates).toEqual([[[10, 10], [20, 20], [10, 40]], [[40, 40], [30, 30], [40, 20], [30, 10]]]);
  ...
  it("should parse a MULTILINESTRING with alternate syntax and Z coordinates", function() {
    ...
    var output = new Terraformer.WKT.parse(input);
    expect(output.coordinates).toEqual([[[10, 10, 10], [20, 20, 20], [10, 40, 30]], [[40, 40, 30], [30, 30, 20], [40, 20, 10], [30, 10, 10]]]);
    expect(output).toBeInstanceOfClass(Terraformer.MultiLineString);
    expect(output.type).toEqual("MultiLineString");
  });
  ...
  it("should parse a MULTILINESTRING with alternate syntax and Z and M coordinates", function() {
    ...
    var output = new Terraformer.WKT.parse(input);
    expect(output.coordinates).toEqual([[[10, 10, 10, 5], [20, 20, 20, 4], [10, 40, 30, 3]], [[40, 40, 30, 2], [30, 30, 20, 1], [40, 20, 10, 2], [30, 10, 10, 3]]]);
    expect(output).toBeInstanceOfClass(Terraformer.MultiLineString);
    expect(output.type).toEqual("MultiLineString");
  });
  it("should parse a MULTIPOLYGON", function() {
    ...
    var output = new Terraformer.WKT.parse(input);
    expect(output.coordinates).toEqual([[[[30, 20], [10, 40], [45, 40], [30, 20]]], [[[15, 5], [40, 10], [10, 20], [5, 10], [15, 5]]]]);
  ...
  it("should parse a MULTIPOLYGON with a Z coordinate", function() {
    ...
    var output = new Terraformer.WKT.parse(input);
    expect(output.coordinates).toEqual([[[[30, 20, 1], [10, 40, 2], [45, 40, 3], [30, 20, 4]]], [[[15, 5], [40, 10], [10, 20], [5, 10], [15, 5]]]]);
    expect(output).toBeInstanceOfClass(Terraformer.MultiPolygon);
    expect(output.type).toEqual("MultiPolygon");
  });
  ...
  it("should parse a MULTIPOLYGON with Z and M coordinates", function() {
    ...
    var output = new Terraformer.WKT.parse(input);
    expect(output.coordinates).toEqual([[[[30, 20, 1, 0], [10, 40, 2, 1], [45, 40, 3, 2], [30, 20, 4, 3]]], [[[15, 5], [40, 10], [10, 20], [5, 10], [15, 5]]]]);
    expect(output).toBeInstanceOfClass(Terraformer.MultiPolygon);
    expect(output.type).toEqual("MultiPolygon");
  });
  it("should parse a MULTIPOLYGON with a hole", function() {
    ...
    var output = new Terraformer.WKT.parse(input);
    expect(output.coordinates).toEqual([[[[40, 40], [20, 45], [45, 30], [40, 40]]], [[[20, 35], [45, 20], [30, 5], [10, 10], [10, 30], [20, 35]], [[30, 20], [20, 25], [20, 15], [30, 20]]]]);
    expect(output).toBeInstanceOfClass(Terraformer.MultiPolygon);
    expect(output.type).toEqual("MultiPolygon");
  });
});
