    ...
    return function r(t, e, n) {
      ...
      7: [function(t, e, n) {
        ...
        e.exports = function(e, n) {
          ...
          var x,
              ...
              G = null,
              M = !1,
              W = !(0 == H.env("BLUEBIRD_DEBUG") || !H.env("BLUEBIRD_DEBUG") && "development" !== H.env("NODE_ENV")),
              $ = !(0 == H.env("BLUEBIRD_WARNINGS") || !W && !H.env("BLUEBIRD_WARNINGS")),
              z = !(0 == H.env("BLUEBIRD_LONG_STACK_TRACES") || !W && !H.env("BLUEBIRD_LONG_STACK_TRACES")),
              X = 0 != H.env("BLUEBIRD_W_FORGOTTEN_RETURN") && ($ || !!H.env("BLUEBIRD_W_FORGOTTEN_RETURN"));
          ...
          e.longStackTraces = function() {
            if (U.haveItemsQueued() && !ot.longStackTraces)
            ...
            if (!ot.longStackTraces && O()) {
              ...
              ot.longStackTraces = !0, K = function() {
                if (U.haveItemsQueued() && !ot.longStackTraces)
                  throw new Error("cannot enable long stack traces after promises have been created\n\n    See http://goo.gl/MqrFmX\n");
                e.prototype._captureStackTrace = t, e.prototype._attachExtraTrace = r, n.deactivateLongStackTraces(), U.enableTrampoline(), ot.longStackTraces = !1;
              }, e.prototype._captureStackTrace = h, e.prototype._attachExtraTrace = _, n.activateLongStackTraces(), U.disableTrampolineIfNecessary();
            }
            ...
            try {
              if ("function" == typeof CustomEvent) {
                ...
                return H.global.dispatchEvent(t), function(t, e) {
                  var n = new CustomEvent(t.toLowerCase(), e);
          ...
          e.config = function(t) {
            if (t = Object(t), "longStackTraces" in t && (t.longStackTraces ? e.longStackTraces() : !t.longStackTraces && e.hasLongStackTraces() && K()), "warnings" in t) {
              var n = t.warnings;
              ot.warnings = !!n, X = ot.warnings, H.isObject(n) && "wForgottenReturn" in n && (X = !!n.wForgottenReturn);
            }
      ...
      8: [function(t, e, n) {
        ...
        e.exports = function(t, e) {
          ...
          t.prototype["return"] = t.prototype.thenReturn = function(r) {
            return r = e(r), r instanceof t && r.suppressUnhandledRejections(), this._then(n, void 0, void 0, {value: r}, void 0);
            ...
            if (arguments.length <= 1)
              return r = e(r), r instanceof t && r.suppressUnhandledRejections(), this._then(void 0, n, void 0, {value: r}, void 0);
            var i = arguments[1];
            i = e(i), i instanceof t && i.suppressUnhandledRejections();
            var o = function() {
              return i;
            };
      ...
      21: [function(t, e, n) {
        ...
        if ("undefined" != typeof Symbol && Symbol.iterator) {
          ...
          L = function(t) {
            return j.isArray(t) ? t : null != t && "function" == typeof t[Symbol.iterator] ? U(t) : null;
          };
        }
