...
(function(process) {
  ...
  Query.prototype.determinePacket = function(firstByte, parser) {
    if (firstByte === 0) {
      if (this._resultSet && this._resultSet.eofPackets.length === 1) {} else if (this._resultSet && this._resultSet.resultSetHeaderPacket && this._resultSet.resultSetHeaderPacket.fieldCount !== null) {
