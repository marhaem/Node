...
var point = require('../examples/point.json!systemjs-json');
linestring = require('../examples/linestring.json!systemjs-json'), polygon = require('../examples/polygon.json!systemjs-json'), poly_hole = require('../examples/polygon_with_hole.json!systemjs-json'), multipoint = require('../examples/multipoint.json!systemjs-json'), multi_ls = require('../examples/multi_linestring.json!systemjs-json'), multi_p = require('../examples/multi_polygon.json!systemjs-json');
